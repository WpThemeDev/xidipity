...
echo '<h2 class="aln:text-center sm)aln:text-left wd:100%">Page Error</h2>' . "\n";
echo '<p class="aln:text-center sm)aln:text-left wd:100%">There was an error loading the requested page.</p>' . "\n";
echo '<!--  fc:BUTTON -->' . "\n";
