 ...
 *
 *  opt (display options)
 *    0 â€“ do not display captions or descriptions (default)
 *    1 â€“ display captions
 *    2 â€“ display descriptions
 *    3 â€“ display both captions and descriptions
 *
 *  fmt
 *    0 - full size
 *    1 - large
        ...
        while ($qry_rslt->have_posts()):
            ...
            case 1:
                ...
                if ($pane == 'L') {
                    ...
                    $html.= '<div style="border-right: solid 1px #e0e0e0; color: var(--fg-pri-900); float: left; font-size: 1.2rem; line-height: 1.8; text-align: center; width: 40px;"><span class="far-glyph">ï‰º</span></div>';
                    $html.= '<div style="float: left; font-size: 0.9375rem; line-height: 2.45; padding-left: 10px;"><a href="' . apply_filters('the_permalink', get_permalink()) . '">Read more â€¦</a></div>';
                    $html.= '</div>';
                    $html.= '</td>';
                }
                else {
