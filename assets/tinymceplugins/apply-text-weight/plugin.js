	...
	editor.addButton('apply_txt_weight', {
		...
		onclick: function () {
			if (!mceReady()) {
				...
				console.clear();
				frmInit();		
				oDoc.datElements = 'font-weight: 400;';
		...
		menu: [{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();		
						oDoc.datElements = 'font-weight: 100;';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'style';
						//
						frmSubmit();
			...
			},
			{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();		
						oDoc.datElements = 'font-weight: 200;';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'style';
						//
						frmSubmit();
			...
			},
			{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();		
						oDoc.datElements = 'font-weight: 300;';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'style';
						//
						frmSubmit();
			...
			},
			{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();		
						oDoc.datElements = 'font-weight: 500;';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'style';
						//
						frmSubmit();
			...
			},
			{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();		
						oDoc.datElements = 'font-weight: 600;';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'style';
						//
						frmSubmit();
			...
			},
			{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();		
						oDoc.datElements = 'font-weight: 700;';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'style';
						//
						frmSubmit();
			...
			},
			{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();		
						oDoc.datElements = 'font-weight: 800;';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'style';
						//
						frmSubmit();
			...
			},
			{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();		
						oDoc.datElements = 'font-weight: 900;';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'style';
						//
						frmSubmit();
...
/*
 * EOF: apply-text-weight / plugin.js / 210704-1
 */
