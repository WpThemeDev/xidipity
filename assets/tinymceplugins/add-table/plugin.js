...
! function() {
	...
	var n, e, t, r, o, i, u = tinymce.util.Tools.resolve("tinymce.PluginManager"),
		...
		E = p.isFunction(Array.from) ? Array.from : function(n) {
			return N.call(n)
		},
		P = {
			map: w,
		...
		V = {
			...
			immutableBag: function(o, i) {
				...
				return H("required", o), H("optional", i), U(u),
					function(e) {
						var t = q.keys(e);
		...
		Qn = function(n) {
			var e, t, r, o, i, u, a, c, l, s, f, d = Jn.browsers(),
				m = Jn.oses(),
	...
	var Pe, Be, Ie, We, Me, Le = function(n, e, t) {
			...
			generate: function(n) {
				...
				P.each(n, function(n, c) {
					...
					P.each(n.cells(), function(n, e) {
						...
						for (var r = Q.extended(n.element(), n.rowspan(), n.colspan(), c, t), o = 0; o < n.colspan(); o++)
		...
		gt = function(n, e) {
			var t, i, r, u, a, c, l, o, s, f, d = function(n) {
				...
				m = Ke(n),
				g = Ze.generate(m),
				h = (i = d, r = (t = g).grid().columns(), u = t.grid().rows(), a = r, l = c = 0, q.each(t.access(), function(n) {
					if (i(n)) {
						var e = n.row(),
							t = e + n.rowspan() - 1,
							r = n.column(),
			...
			return P.each(v, dt.remove),
				function(n, e, t, r) {
					for (var o, i, u, a = e.grid().columns(), c = e.grid().rows(), l = 0; l < c; l++)
						for (var s = !1, f = 0; f < a; f++) l < t.minRow() || l > t.maxRow() || f < t.minCol() || f > t.maxCol() || (Ze.getAt(e, l, f).filter(r).isNone() ? (o = s, i = n[l].element(), u = nn.fromTag("td"), lt.append(u, nn.fromTag("br")), (o ? lt.append : lt.prepend)(i, u)) : s = !0)
	...
	var qt = V.immutable("left", "right"),
		...
		ur = function(n, e) {
			for (var t = !0, r = y.curry(or, e), o = e.startRow(); o <= e.finishRow(); o++)
				for (var i = e.startCol(); i <= e.finishCol(); i++) t = t && Ze.getAt(n, o, i).exists(r);
		...
		yr = function(a, c, r) {
			...
			return te.eq(a, c) ? x.some(wr({
				boxes: x.some([a]),
				start: a,
				finish: c
			})) : br(a).bind(function(u) {
				return br(c).bind(function(i) {
					if (te.eq(u, i)) return x.some(wr({
						boxes: hr(u, a, c),
						start: a,
						finish: c
					}));
	...
	var Fr = Hr("height", function(n) {
		...
		So = {
			delta: y.identity,
			positions: y.curry(Ro, function(n, e) {
				return po(n, Co(e))
			}, function(n, e) {
	...
	var Oo = function(n) {
		...
		Lo = function(r, n) {
			...
			var t = No(x.none()),
				...
				u = function(n) {
					var e = i(n);
					return t.get().isNone() && t.set(x.some(e)), a = x.some({
						item: n,
						replacement: e
					}), e
				},
		...
		_o = ["body", "p", "div", "article", "aside", "figcaption", "figure", "footer", "header", "nav", "section", "ol", "ul", "table", "thead", "tfoot", "tbody", "caption", "tr", "td", "th", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "pre", "address"],
		zo = function(n, e) {
		...
		ai = function(n, e, t, r) {
			var o, i, u, a, c = (o = n, i = e, o[i]).cells().slice(t),
				l = ui(c, r),
				s = (u = n, a = t, P.map(u, function(n) {
		...
		Zi = function(e, n) {
			var t = P.map(n.selection(), function(n) {
				...
				r = ei(t);
			return 0 < r.length ? x.some(ni.merge({
				cells: r
			}, {
		...
		fu = function(n, e, t, r) {
			...
			for (var o = e.startRow(); o <= e.finishRow(); o++)
				for (var i = e.startCol(); i <= e.finishCol(); i++) ii.mutateCell(n[o], i, Q.elementnew(r(), !1));
			return n
		},
		du = function(n, e, t, r) {
		...
		mu = function(i, u, a, c) {
			if (0 < u && u < i.length) {
				var n = i[u - 1].cells(),
					e = (t = n, r = a, P.foldl(t, function(n, e) {
		...
		gu = function(t, r, o, i, u) {
			return cu(t, r, o).map(function(n) {
				...
				return function(n, e, t, r, o) {
					for (var i, u, a, c, l, s, f, d = n.row(), m = n.column(), g = d + t.length, h = m + ii.cellLength(t[0]), p = d; p < g; p++)
						for (var v = m; v < h; v++) {
		...
		Bu = function(n, e, i, u) {
			var t, r, a = n.slice(0),
				o = (r = e, 0 === (t = n).length ? Au() : 1 === t.length ? Ou(0) : 0 === r ? Nu(0, 1) : r === t.length - 1 ? Pu(r - 1, r) : 0 < r && r < t.length - 1 ? Eu(r - 1, r, r + 1) : Au()),
				c = function(n) {
		...
		sa = {
			...
			insertRowsBefore: Yi(function(n, e, t, r) {
				var o = e[0].row(),
					i = e[0].row(),
					u = ua(e),
					a = P.foldl(u, function(n, e) {
						return pu(n, i, o, t, r.getOrInit)
					}, n);
				return ia(a, i, e[0].column())
			}, Ji, y.noop, y.noop, Lo),
			insertRowAfter: Yi(function(n, e, t, r) {
				var o = e.row(),
					i = e.row() + e.rowspan(),
					u = pu(n, i, o, t, r.getOrInit);
				return ia(u, i, e.column())
			}, $i, y.noop, y.noop, Lo),
			insertRowsAfter: Yi(function(n, e, t, r) {
				var o = ua(e),
					i = o[o.length - 1].row(),
					u = o[o.length - 1].row() + o[o.length - 1].rowspan(),
					a = P.foldl(o, function(n, e) {
						return pu(n, u, i, t, r.getOrInit)
					}, n);
				return ia(a, u, e[0].column())
			}, Ji, y.noop, y.noop, Lo),
			insertColumnBefore: Yi(function(n, e, t, r) {
				var o = e.column(),
					i = e.column(),
					u = vu(n, i, o, t, r.getOrInit);
				return ia(u, e.row(), i)
			}, $i, la, y.noop, Lo),
			insertColumnsBefore: Yi(function(n, e, t, r) {
				var o = aa(e),
					i = o[0].column(),
					u = o[0].column(),
					a = P.foldl(o, function(n, e) {
			...
			insertColumnAfter: Yi(function(n, e, t, r) {
				var o = e.column(),
					i = e.column() + e.colspan(),
					u = vu(n, i, o, t, r.getOrInit);
				return ia(u, e.row(), i)
			}, $i, la, y.noop, Lo),
			insertColumnsAfter: Yi(function(n, e, t, r) {
			...
			splitCellIntoColumns: Yi(function(n, e, t, r) {
				var o = bu(n, e.row(), e.column(), t, r.getOrInit);
				return ia(o, e.row(), e.column())
			}, $i, la, y.noop, Lo),
			splitCellIntoRows: Yi(function(n, e, t, r) {
				var o = wu(n, e.row(), e.column(), t, r.getOrInit);
				return ia(o, e.row(), e.column())
			}, $i, y.noop, y.noop, Lo),
			eraseColumns: Yi(function(n, e, t, r) {
				var o = aa(e),
					i = xu(n, o[0].column(), o[o.length - 1].column()),
					u = ra(i, e[0].row(), e[0].column());
				return ta(i, u)
			}, Ji, la, ea, Lo),
			eraseRows: Yi(function(n, e, t, r) {
				var o = ua(e),
					i = yu(n, o[0].row(), o[o.length - 1].row()),
					u = ra(i, e[0].row(), e[0].column());
				return ta(i, u)
			}, Ji, y.noop, ea, Lo),
			makeColumnHeader: Yi(function(n, e, t, r) {
				var o = Tu(n, e.column(), t, r.replaceOrInit);
				return ia(o, e.row(), e.column())
			}, $i, y.noop, y.noop, qo("row", "th")),
			unmakeColumnHeader: Yi(function(n, e, t, r) {
				var o = Tu(n, e.column(), t, r.replaceOrInit);
				return ia(o, e.row(), e.column())
			}, $i, y.noop, y.noop, qo(null, "td")),
			makeRowHeader: Yi(function(n, e, t, r) {
				var o = Du(n, e.row(), t, r.replaceOrInit);
				return ia(o, e.row(), e.column())
			}, $i, y.noop, y.noop, qo("col", "th")),
			unmakeRowHeader: Yi(function(n, e, t, r) {
				var o = Du(n, e.row(), t, r.replaceOrInit);
				return ia(o, e.row(), e.column())
			}, $i, y.noop, y.noop, qo(null, "td")),
			mergeCells: Yi(function(n, e, t, r) {
				var o = e.cells();
				$o(o);
				var i = fu(n, e.bounds(), t, y.constant(o[0]));
				return ta(i, x.from(o[0]))
			}, nu, y.noop, y.noop, jo),
			unmergeCells: Yi(function(n, e, t, r) {
				var o = P.foldr(e, function(n, e) {
					return du(n, e, t, r.combine(e))
				}, n);
				return ta(o, x.from(e[0]))
			}, eu, la, y.noop, jo),
			pasteCells: Yi(function(n, t, e, r) {
				var o, i, u, a, c = (o = t.clipboard(), i = t.generators(), u = Ke(o), a = Ze.generate(u), li(a, i, !0)),
			...
			pasteRowsBefore: Yi(function(n, e, t, r) {
			...
			pasteRowsAfter: Yi(function(n, e, t, r) {
				var o = n[e.cells[0].row()],
					i = e.cells[e.cells.length - 1].row() + e.cells[e.cells.length - 1].rowspan(),
					u = ca(e.clipboard(), e.generators(), o),
					a = hu(i, n, u, e.generators(), t),
					c = ra(a, e.cells[0].row(), e.cells[0].column());
				return ta(a, c)
		...
		Ca = ["tableprops", "tabledelete", "|", "tableinsertrowbefore", "tableinsertrowafter", "tabledeleterow", "|", "tableinsertcolbefore", "tableinsertcolafter", "tabledeletecol"],
		Ra = {
		...
		La = function(s, n) {
			var e, t = function(n) {
				...
				f = (e = s.getParam("table_clone_elements"), p.isString(e) ? x.some(e.split(/[ ,]/)) : Array.isArray(e) ? x.some(e) : x.none()),
				r = function(u, a, c, l) {
					return function(n, e) {
						pa(n);
						var t = l(),
		...
		qa = function(n, e, r) {
			...
			return Ji(o, e).map(function(n) {
				var e = li(o, r, !1).slice(n[0].row(), n[n.length - 1].row() + n[n.length - 1].rowspan()),
					t = Ki(e, r);
				return di(t)
			})
		},
	...
	var Za = function(e) {
			var n, t, r, o, i, u, a, c, l, s, f = e.dom,
				d = [];
		...
		uc = function(i, n, e) {
			var t, r, o = i.getParam("table_default_styles", Ra, "object"),
				u = {
					styles: o,
	...
	var cc = function(n, e, t) {
				...
				e || (e = uc(n, o.cols || 1, o.rows || 1)),
					function(n, e, t) {
						...
						if (i["class"] = t["class"], u.height = ha(t.height), o.getAttrib(e, "width") && !Aa(n) ? i.width = (r = t.width) ? r.replace(/px$/, "") : "" : u.width = ha(t.width), Aa(n) ? (u["border-width"] = ha(t.border), u["border-spacing"] = ha(t.cellspacing), ja.extend(i, {
							...
							for (var a = 0; a < e.children.length; a++) ac(o, e.children[a], {
		...
		lc = function(e, n) {
			var t, r, o, i, u, a, c, l, s, f, d = e.dom,
				m = {};
	...
	var hc = {
		...
		bc = function(m, g) {
			return function(n) {
				if (m(n)) {
					var e, t, r, o, i, u, a, c = nn.fromDom(n.target),
						l = function() {
							n.stopPropagation()
						},
						s = function() {
						...
						f = y.compose(s, l),
						d = (e = c, t = n.clientX, r = n.clientY, o = l, i = s, u = f, a = n, {
							target: y.constant(e),
							x: y.constant(t),
							y: y.constant(r),
							stop: o,
		...
		Tc = pc.mode({
			...
			sink: function(n, e) {
				var t, r, o, i = (t = e, r = ni.merge({
						layerClass: vc.resolve("blocker")
					}, t), o = nn.fromTag("div"), Se.set(o, "role", "presentation"), ut.setAll(o, {
						position: "fixed",
						left: "0px",
						top: "0px",
						width: "100%",
	...
	var rs = function(t, n, r, e, o) {
		...
		js = (V.immutable("ancestor", "descendants", "element", "index"), V.immutable("parent", "children", "element", "index")),
		_s = function(n, e) {
		...
		Qs = function(e, t, r) {
			return (o = e, i = t, u = r, o.getSelection().bind(function(r) {
				return Vs(i, r.finish(), r.foffset(), u).fold(function() {
					...
					var e = o.fromSitus(n),
						t = Ls.verify(o, r.finish(), r.foffset(), e.finish(), e.foffset(), u.failure, i);
					return Gs(t)
				})
			})).bind(function(n) {
		...
		sf = {
			mouse: function(n, e, t, r) {
				var o, i, u, a, c, l, s = ts(n),
					f = (o = s, i = e, u = t, a = r, c = x.none(), l = function() {
						c = x.none()
					}, {
	...
	function pf(h, p) {
		var v = V.immutableBag(["mousedown", "mouseover", "mouseup", "keyup", "keydown"], []),
			b = x.none(),
			w = gf.byAttr(Nr);
	...
	var vf = ja.each,
		bf = function(e) {
			...
			vf("inserttable tableprops deletetable | cell row column".split(" "), function(n) {
				...
				title: "Table",
				icon: 'mce-table',
				image: 'data:image/svg+xml;base64,',
				menu: t
		...
		yf = function(o, t) {
			...
			var f = function(n, e, t, r) {
					...
					for (l.nextSibling.innerHTML = e + 1 + " x " + (t + 1), s && (e = 9 - e), i = 0; i < 10; i++)
						for (o = 0; o < 10; o++) a = l.rows[i].childNodes[o].firstChild, c = (s ? e <= o : o <= e) && i <= t, n.dom.toggleClass(a, "mce-active", c), c && (u = a);
					return u.parentNode
				},
		...
		xf = function(t, o) {
			return {
				...
				getClipboardRows: function() {
					return o.get().fold(function() {}, function(n) {
						return P.map(n, function(n) {
							return n.dom()
						})
					})
...
/*
 * EOF: add-table / plugin.js / 27200615
 */
