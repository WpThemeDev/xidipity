...
tinymce.PluginManager.add('apply_txt_formats', function (editor) {
	...
	editor.addButton('apply_txt_formats', {
		...
		menu: [{
			...
			{
				icon: true,
				image: 'data:image/svg+xml;base64,',
				text: '\xa0Small Caps',
				onclick: function () {
					if (!mceReady()) {
						_err.display();
...
},
			{
				...
				onclick: function () {
					if (!mceReady()) {
						...
						console.clear();
						frmInit();
						oDoc.datElements = 'trn:shadow-md';
						oDoc.datAction = 'blend';
						oDoc.datAttribute = 'class';
						//
						frmSubmit();
...
/*
 * EOF: apply-text-format / plugin.js / 210704-1
 */
