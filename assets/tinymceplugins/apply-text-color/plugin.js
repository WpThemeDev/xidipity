				...
				editor.windowManager.open({
					...
					onClick: function (event) {												
						...
						if (!isEmpty(frmHexValue) || !isEmpty(frmGrdValue)) {
							...
							switch (true) {
								case (!isEmpty(frmGrdValue.match(/hex_id|bkg_id/))):
									//
									console.log('     - Mark -');
									//
									break;
