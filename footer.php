...
if (xty('ftr-aln') == 'left')
{
	...
	echo '<div class="aln:txt-lt dsp:block fnt:size-smaller">' . "\n";
}
elseif (xty('ftr-aln') == 'right')
{
	echo '<footer class="fx:r fxa:2 fxc:3 ht:min6 fb:100%">' . "\n";
	echo '<div class="aln:txt-rt dsp:block fnt:size-smaller">' . "\n";
}
else
{
	echo '<footer class="fx:r fxa:3 fxc:3 ht:min6 fb:100%">' . "\n";
	echo '<div class="aln:txt-ct dsp:block fnt:size-smaller">' . "\n";
}
