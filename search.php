...
else
{
    ...
    echo '<h2 class="aln:text-center sm)aln:text-left wd:100%">Search Error</h2>' . "\n";
    echo '<p class="aln:text-center sm)aln:text-left wd:100%">The specified search criteria did not return any records.</p>' . "\n";
    echo '<!--  fc:BUTTON -->' . "\n";
